...
setwd("G:/My Drive/Projects/Summit County - COVID-19/COVID-19/Database/Datawrapper")
...
# Five-month cutoff date
cutoff_six_month_ago <- Sys.Date() - 180
# Subset 5 months of hospitalziation data for bar plot
hosp_six_month <- subset(hosp_comp, Date >= cutoff_six_month_ago)
# Write csv
write.csv(hosp_six_month, "hospitalizations_6mo_prior.csv", row.names=F)
